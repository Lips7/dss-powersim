...
```{python, eval=TRUE, echo=TRUE, results=FALSE}
...
```{stata, collectcode=TRUE, eval=TRUE, echo=TRUE, results=FALSE}
...
tibble::tribble(~`lang`, ~`parameters`, ~`average`,
        "r", "All parameters", r_average,
        "python", "All parameters", py$python_average,
